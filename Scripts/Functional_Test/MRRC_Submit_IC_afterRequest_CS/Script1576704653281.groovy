...
1.times({ 
        ...
        WebUI.selectOptionByLabel(findTestObject('Old_Objects/INTAKE_P1_Central_Coder_Queue_Page/select_Select Step'), 'Invalid Confirmation', 
            false)
...
WebUI.click(findTestObject('CENTRAL_CODER/INTAKE_NEW_P4_Invalid_Confirmation_Page/Validate_Section/Section_2_Enter date of service/Section2_input_attestationStartDate'))
...
WebUI.click(findTestObject('CENTRAL_CODER/INTAKE_NEW_P4_Invalid_Confirmation_Page/POP_UP_Modal/button_Complete_popup'))
