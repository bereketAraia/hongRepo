...
WebUI.setText(findTestObject('USER_Management/P0_Login_Page_Global/Input_Username_box'), GlobalVariable.stMrrc3User1)
...
WebUI.verifyElementPresent(findTestObject('CENTRAL_CODER/INTAKE_NEW_P6_Discrepant_Confirmation_Page/Validate_Section/section4_label_Provide any general comm'), 
    0)
...
WebUI.verifyElementText(findTestObject('CENTRAL_CODER/INTAKE_NEW_P6_Discrepant_Confirmation_Page/Validate_Section/section4_label_Provide any general comm'), 
