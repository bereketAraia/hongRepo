...
WebUI.verifyElementPresent(findTestObject('CENTRAL_CODER/INTAKE_NEW_P6_Discrepant_Confirmation_Page/Details_Section/detail_li_DOB'), 0)
...
WebUI.verifyElementPresent(findTestObject('CENTRAL_CODER/INTAKE_NEW_P6_Discrepant_Confirmation_Page/Footer_Section/button_Exit'), 0)
