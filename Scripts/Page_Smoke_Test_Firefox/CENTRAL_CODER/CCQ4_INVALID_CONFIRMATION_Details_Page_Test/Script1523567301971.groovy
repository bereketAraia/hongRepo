...
WebUI.verifyElementPresent(findTestObject('CENTRAL_CODER/INTAKE_NEW_P4_Invalid_Confirmation_Page/Hero_section/hero_button_Details'), 0)

WebUI.verifyElementPresent(findTestObject('CENTRAL_CODER/INTAKE_NEW_P4_Invalid_Confirmation_Page/Hero_section/button_Validate'), 0)
