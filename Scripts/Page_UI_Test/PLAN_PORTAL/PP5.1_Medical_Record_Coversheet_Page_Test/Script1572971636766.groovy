...
WebUI.setText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/input_admitDate'), '04-19-2014')
...
WebUI.setText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/input_releaseDate'), '12-19')
...
'RM-60.5 : Review button is not enabled'
WebUI.click(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/button_Review'), FailureHandling.CONTINUE_ON_FAILURE)
...
'RM-60.3 : Part of Hierarchy confirmed'
WebUI.verifyElementPresent(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/HCC_Tab1_(Part of a hierarchy)'), 
    0)

'RM-60.2 : ICD-9 codes are listed '
WebUI.verifyElementPresent(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/HCC_Tab1_ICD9_codes'), 
    0)

icd9_codes = WebUI.getText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/HCC_Tab1_ICD9_codes'))

WebUI.delay(3)

println(icd9_codes)

'RM-60.6. : CANCEL button is available'
WebUI.verifyElementPresent(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/button_Cancel'), 0)

'RM-60.5 : review button is enabled'
WebUI.verifyElementPresent(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/button_Review'), 2)

WebUI.delay(2)

'RM-60.7'
WebUI.click(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/button_Cancel'))

WebUI.delay(2)

'RM-60.10 : resume coversheet'
WebUI.click(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/button_Cancel - Resume Coversheet _button'))

WebUI.delay(2)

'RM-60.10 : page stays on "Medical Record Coversheet "'
WebUI.verifyElementText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/hero_h1_Medical Record Coversheet'), 
    'Medical Record Coversheet')
...
'RM:60.8 : message : If you proceed ... exists'
WebUI.verifyElementText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/button_Cancel - Cancel_Text_If you proceed'), 
    'If you proceed with cancelling, this coversheet will not be saved.')

WebUI.delay(3)

'RM-60.9 :  Exit back to enrollee Submission page '
WebUI.click(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/button_Cancel - Proceed with Cancel'))

WebUI.delay(3)

'RM-60.9  : back to enrollee'
