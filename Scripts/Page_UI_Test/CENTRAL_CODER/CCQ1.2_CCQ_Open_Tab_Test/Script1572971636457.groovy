...
'RM-304.7 :varify clear filter button  is present'
...
WebUI.click(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/filter_button_Clear Filters'))

'RM-304.6 : varify Submission Review filter  is present'
...
'RM-304.6 : varify Senior Evaluation filter  is present'
...
'RM-304.10'
WebUI.verifyElementClickable(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/Table_1st Contract on table'))
...
'RM-304.2 :varify REQUEST TASK  is present'
...
WebUI.verifyElementClickable(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/bottom_button_Request Task'), 
