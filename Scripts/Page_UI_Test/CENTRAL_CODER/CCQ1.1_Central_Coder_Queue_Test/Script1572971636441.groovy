...
'RM-501.2'
WebUI.waitForElementClickable(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/Hero/hero_a_Open (11)'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/Hero/hero_button_CY 2013 Contract-Level'), 
    0)

WebUI.verifyElementPresent(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/Hero/hero_button_CY 2014 Contract-Level'), 
    2)

WebUI.verifyElementPresent(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/Hero/hero_button_CY 2015 Contract-Level'), 
    0)

'RM-501.3 : varify OPEN() tab is present'
WebUI.verifyElementPresent(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/Hero_Tab_a_Open ()'), 0)

'RM-501.3 : varify IN ESCALATION() tab is present'
...
'RM-501.3  : varify COMPLETED() tab is present'
...
'RM-501.7 : varify OPEN() tab is present'
...
'RM-500.7'
WebUI.waitForElementClickable(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/bottom_button_Request Task'), 
    0)

WebUI.delay(2)

'RM-500.8 RM-500.9 : Request a task'
WebUI.click(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/bottom_button_Request Task'))
